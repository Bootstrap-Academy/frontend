<template>
  <div class="flex justify-center">
    <div class="md:flex md:space-x-8 max-md:space-y-8 md:max-w-4xl">
      <div
        class="w-full border border-accent rounded-xl p-8 m-3 shadow-xl md:w-1/2"
        v-if="!isPremium"
      >
        ...
        <div
          class="flex items-center justify-center space-x-4 border border-tertiary rounded-full px-6 py-3 mb-8"
        >
      ...
      <div
        class="w-full bg-accent text-black rounded-xl p-8 m-3 shadow-xl"
      ...
      >
        ...
        <div
          ...
          role="button"
          :class="{
            'flex items-center justify-center space-x-4 border border-white duration-200 bg-white shadow-lg rounded-full px-6 py-3 mb-8 active:scale-95 cursor-pointer hover:scale-105':
              hasEnoughCoins,
            'flex items-center justify-center space-x-4 border border-tertiary duration-200 rounded-full px-6 py-3 cursor-default':
              !hasEnoughCoins,
          }"
        >
