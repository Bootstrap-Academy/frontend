<template>
  <article class="p-4 style-card lg:style-box bg-secondary border-l-4" :class="[theme.border]">
    <header class="flex justify-between gap-x-card gap-y-2 flex-wrap-reverse mb-4">
