<template>
  ...
  >
    <SvgHero />
    <article class="max-w-5xl relative z-20 text-center flex flex-col justify-center items-center">
      <strong class="text-heading-2 text-accent font-heading">
        {{ t('Subheadings.Hero') }}
      </strong>

      <h1 class="text-display-1 font-heading mb-box">
        {{ t('Headings.Hero') }}
      </h1>
