<template>
  <div>
    ...
    >
      <p
        v-if="isEdit"
        class="text-body-1 w-fit px-4 py-2 text-warning bg-warning-light style-card mb-card"
      >
      ...
      <div
        class="flex flex-wrap items-center justify-center self-end gap-card mt-card sm:justify-end"
      >
