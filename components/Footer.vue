<template>
  ...
  >
    ...
    <section
      class="flex w-full flex-wrap-reverse justify-center border-t border-subheading py-6 gap-container midXl:flex-nowrap"
    >
      <p class="mt-0.5 text-center text-sm text-subheading md:text-left">
