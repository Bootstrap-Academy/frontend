<template>
  <section>
    ...
    <div class="max-h-[175px] overflow-hidden md:max-h-fit md:overflow-auto">
      <div
        class="hide-scrollbar flex snap-x snap-mandatory overflow-x-scroll gap-card-sm md:grid md:grid-cols-4"
      >
        <template v-if="loading">
          <CourseCardSmSkeleton
            v-for="n in 5"
            :key="n"
            :class="{ 'md:col-span-2 md:row-span-2': n == 1 }"
