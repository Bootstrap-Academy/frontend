<template>
  <main class="bg-white h-screen-inner container w-full overflow-scroll pt-container pb-container">
    <h1 v-if="locale == 'de'" class="mb-2 text-heading-1 text-subheading">
      ...
      für
      <span class="text-black font-black font-body">{{ coinsInEuros }} euros</span>
      kaufen
    </h1>
    ...
    <article class="mb-card">
      <h2 class="text-heading-2 text-black font-black mb-2 flex gap-card items-center flex-wrap">
      ...
      <template v-if="user.business">
        <div class="flex gap-box">
          <h3 class="text-body m-0 text-body-1">{{ t('Inputs.FirstName') }}:</h3>
